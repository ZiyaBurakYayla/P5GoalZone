        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeScoreFT = table.Column<int>(type: "int", nullable: true),
                    AwayScoreFT = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubstitutedPlayerName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecondHalfScore = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HomePossession = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    AwayPossession = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    HomeTotalShots = table.Column<int>(type: "int", nullable: true),
                    AwayTotalShots = table.Column<int>(type: "int", nullable: true),
                    ...
                    HomePassAccuracy = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    AwayPassAccuracy = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
